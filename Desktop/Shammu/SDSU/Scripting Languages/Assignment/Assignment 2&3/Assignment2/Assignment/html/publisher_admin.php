...
<?php
  ...
  while($row = mysqli_fetch_array($result)) {
    ...
    <form name="images_form" method="post" action = "images.php">
    <input type="hidden" name="ISBN" value="'.$row['ISBN'].'" />
    <input type="hidden" name="bookName" value="'.$row['Name'].'" />
    <td><input type="submit" id="sample_image" name="sample_image"  value="Images"/></td>
    </form>
    
    </tr>';
  }
  // <td><a id="sample_images" href="images.php"><button>Images</button></a></td>
  echo'</table>';
