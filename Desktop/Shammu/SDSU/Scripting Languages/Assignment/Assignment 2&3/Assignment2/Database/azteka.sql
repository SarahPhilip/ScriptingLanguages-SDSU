...
--
-- Host: localhost
-- Generation Time: May 08, 2015 at 12:44 AM
...
INSERT INTO `books` (`ISBN`, `Name`, `Author`, `Publisher`, `Price`, `BestSeller`, `Published`, `numberSold`) VALUES
(1, 'ABC', 7, 10, 10, 1, 1, 13),
(2, 'DEF', 8, 10, 20, 1, 1, 3),
(3, 'GHIl', 11, 10, 190, 0, 1, 5),
(10, 'JKL', 7, 10, 10, 0, 1, 4),
(11, 'Famous Five I', 11, 10, 20, 0, 1, 10),
(14, 'FROZEN', 8, 10, 30, 1, 1, 3),
(15, 'QWERTY', 8, 10, 10, 0, 1, 8),
(16, 'AABBCC', 10, NULL, 0, 0, 0, 10),
(17, 'PHP', 10, 10, 30, 1, 1, 14);
