...
<div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Member Admin
                    <small>Azteka</small>
                </h1>
                <ol class="breadcrumb">
                    <li><a href="index.php">Home</a>
                    </li>
                    <li class="active">Member Admin</li>
                </ol>
            </div>
        </div>
<form name="login"  
            id="login" action="change_password.php" method="post">
...
<fieldset>
                <ol>
                    <li>
                        ...
                        <input type="password" name="password1" size="20" maxlength="20" placeholder="******" />
                    </li>
                    <li>
                        <label for="pass">Confirm Password:</label>
                        <input type="password" name="password2" size="20" maxlength="20" placeholder="******" />
                    </li> 
                </ol>
            </fieldset>
