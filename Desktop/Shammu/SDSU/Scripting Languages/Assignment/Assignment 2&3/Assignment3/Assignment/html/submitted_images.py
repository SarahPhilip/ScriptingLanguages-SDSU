...
x = (W-w)/2
y = ((H-h)/2) - 50 
font1 = ImageFont.truetype('/Library/anaconda/lib/python3.4/site-packages/matplotlib/mpl-data/fonts/ttf/Vera.ttf', 25)
dr.text((x,y), text_message, font=font1, fill="white")
