        ...
        <fieldset>
            <ol>
                <li>
                    ...
                    <input type="text" name="first_name" size="20" maxlength="20" value="<?php if (isset($trimmed['first_name'])) echo $trimmed['first_name']; ?>" placeholder="Firstname" />
                </li>
                <li>
                    <label for="last_name">Last Name:</label>
                    <input type="text" name="last_name" size="20" maxlength="40" value="<?php if (isset($trimmed['last_name'])) echo $trimmed['last_name']; ?>" placeholder="******" />
                </li>
                <li>
                    <label for="email">E-mail:</label>
					<input type="text" name="email" size="30" maxlength="60" value="<?php if (isset($trimmed['email'])) echo $trimmed['email']; ?>" placeholder="example@example.com" />                    
				</li>
                <li>
